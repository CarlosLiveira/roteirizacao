...
public class RegiaoService {
	...
	public List<RegiaoDto> listar(){
		...
		List<RegiaoDto> regioesDto = regioes.stream().map(x -> RegiaoDto.toDto(x))
	...
	public RegiaoDto findById(Long codigo) {
		Regiao regiao = regiaoRepository.findById(codigo).orElseThrow(
				() -> new EntityNotFoundException("Região não localizada " + codigo));
